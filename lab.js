...
//CODE HERE
var amysName = "Amy";
var brittanisName = "Britani";

if(amysAge > brittanisAge) console.log(`${amysName} is older`);
else if(brittanisAge > amysAge) console.log(`${brittanisName} is older`);
else if(amysAge === brittanisAge) console.log(`${amysName} and ${brittanisName} are the same age`);
else console.log("Error?? undefined age??");
...
//CODE HERE
if(amysBirthYear === brittanisBirthYear) console.log(`${amysName} & ${brittanisName} were born in the same year`);
else if(amysBirthYear !== brittanisBirthYear) console.log(`${amysName} & ${brittanisName} were not born in the same year`)
else console.log("Error?? Undefined years??");
...
//Code Here
for(let i = 0; i < listOfNumbers.length; ++i) if(listOfNumbers[i] % 3 === 0) console.log(`${listOfNumbers[i]} is divisible by three`)
...
//Code Here
for(let i = letters.length - 1; i > -1; i--) console.log(letters[i]); 
